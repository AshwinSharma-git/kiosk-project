from flask import Flask, Response, render_template, request, redirect, url_for, send_from_directory, jsonify, session, flash
import datetime
import os 
import re
...
def future_missions():
    missions_data = {
        ...
        'nisar': {
            'title': 'NISAR',
            'launch': '2024',
            'description': 'NASA-ISRO Synthetic Aperture Radar (NISAR) mission for Earth observation.',
            'key_features': [
                'Advanced radar imaging',
                'Natural hazard response',
                'Ecosystem monitoring',
                'Ice sheet dynamics study',
                'Global environmental change monitoring'
            ],
            'image': '/static/images/future/nisar.jpg'
        },
        'spacestation': {
...
def working_models():
    models = {
        ...
        'telescope': {
            ...
            'thumbnail': '/static/images/working_models/telescope-thumb.jpg',            'description': 'Experience the operation of advanced astronomical telescopes used in space research. This model demonstrates tracking, imaging, and data collection techniques.'
        }
    }
